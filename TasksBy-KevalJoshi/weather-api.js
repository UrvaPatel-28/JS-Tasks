...
function addDropdown(cityList) {
    ...
    cityList.forEach((city) => {
        ...
        // for (i = 0; i <= cityDropdown.children.length; i++) {
        //     if (cityDropdown.children[i].value != option.value) {
        //         cityDropdown.appendChild(option);
        //         console.log(cityDropdown.children[i].value);
